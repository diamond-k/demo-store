  ...
  <div class="product-details">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12 product-details-info">
          ...
          <div class="product-details-price-cart">
            <p>£{{product.price}}</p>
            <product-button :product="product" :isAdding= "isAdding"></product-button>
          </div>
        </div>
      </div>
    </div>
